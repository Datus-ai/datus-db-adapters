...
def test_tpch_get_tables(tpch_setup: TiDBConnector):
...
@pytest.mark.integration
def test_tpch_get_columns(tpch_setup: TiDBConnector):
...
@pytest.mark.integration
def test_tpch_get_columns_nation(tpch_setup: TiDBConnector):
...
def test_tpch_query_region(tpch_setup: TiDBConnector):
...
@pytest.mark.integration
@pytest.mark.acceptance
def test_tpch_query_nation(tpch_setup: TiDBConnector):
...
@pytest.mark.integration
def test_tpch_query_join(tpch_setup: TiDBConnector):
...
@pytest.mark.integration
def test_tpch_query_aggregation(tpch_setup: TiDBConnector):
...
@pytest.mark.integration
def test_tpch_query_customer_orders(tpch_setup: TiDBConnector):
...
@pytest.mark.integration
def test_tpch_query_csv_format(tpch_setup: TiDBConnector):
...
@pytest.mark.integration
def test_tpch_query_arrow_format(tpch_setup: TiDBConnector):
    ...
    assert result.success
    # Arrow format returns a PyArrow Table
...
@pytest.mark.integration
def test_tpch_query_pandas_format(tpch_setup: TiDBConnector):
    ...
    assert result.success
    # Pandas format returns a DataFrame
